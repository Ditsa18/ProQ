    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex items-center justify-between px-3.5 py-2.5 border-b border-gray-100 flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-[13px] font-semibold text-gray-900">Live Transcript</div>
            <div className="text-[10px] text-gray-400">Real-time speech to text</div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          {isProcessing && (
            <>
              ...
              <span className="text-[11px] text-gray-400">Status: {status}</span>
            </>
          )}
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto flex flex-col overflow-x-hidden">
        ...
        {messages.length === 0 && (
          <div className="flex-1 flex items-center justify-center">
            <span className="text-[12px] text-gray-300">Waiting for call to start...</span>
          </div>
        )}
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-t border-gray-100 flex-shrink-0">
        <div className="flex items-end gap-[2px] h-3">
          <span className="w-[2px] h-[4px] bg-blue-400 rounded-sm animate-pulse" style={{ animationDelay: "0ms" }} />
          <span className="w-[2px] h-[10px] bg-blue-500 rounded-sm animate-pulse" style={{ animationDelay: "100ms" }} />
          <span className="w-[2px] h-[6px] bg-blue-400 rounded-sm animate-pulse" style={{ animationDelay: "200ms" }} />
          <span className="w-[2px] h-[10px] bg-blue-500 rounded-sm animate-pulse" style={{ animationDelay: "300ms" }} />
          <span className="w-[2px] h-[4px] bg-blue-400 rounded-sm animate-pulse" style={{ animationDelay: "400ms" }} />
        </div>
        <span className="text-[11px] text-gray-400">
          {isProcessing ? "Processing incoming audio..." : "Call not started"}
        </span>
      </div>
